...
Download GUI application of it here, capable of documenting UE4 projects and plugins (only works on non-built-in plugins. A built-in plugin is one that comes with the engine. If you need a plugin to try it out on create one inside a project or download a free one from the marketplace): 
